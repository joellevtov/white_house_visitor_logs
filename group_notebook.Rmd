...
#That looks better. Let's use appt end date because it seems to be the date col with the most data and fewest NAs. However, we need to take the time out since some say 11:59 and some say 23:59.

wh_visitor_data <- wh_visitor_data |>
  mutate(appt_end_date = )
