...
I think we might need to abandon ship on this - it's a lot of cleaning and openrefine is super slow because our dataset is huge plus i think it's just biden. 
```{r}
open_refine_cleaned_visitors <- read_csv()
```
